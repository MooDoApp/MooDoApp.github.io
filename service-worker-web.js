var CacheName = 'moodo-cache-1582076981580',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1582076981580.html',
                '/web/js/vendor-1582076981580.js',
                '/web/js/delayedUI-1582076981580.js',
                '/web/js/dimport-1582076981580.js',
                '/web/js/app-1582076981580.js',
                '/web/js/preload-1582076981580.js',
                '/web/js/preload.worker-1582076981580.js',
                '/web/css/app-min-1582076981580.css',
                '/web/css/fonticons-1582076981580.css',
                '/web/css/fonts/fonticons-1582076981580.woff',
                '/web/css/fonts/fonticons-1582076981580.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1582076981580.html');
        }

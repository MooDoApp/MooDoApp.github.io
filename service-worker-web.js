var CacheName = 'moodo-cache-1556595360772',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1556595360772.html',
                '/web/js/vendor-1556595360772.js',
                '/web/js/delayedUI-1556595360772.js',
                '/web/js/dimport-1556595360772.js',
                '/web/js/app-1556595360772.js',
                '/web/js/preload-1556595360772.js',
                '/web/js/preload.worker-1556595360772.js',
                '/web/css/app-min-1556595360772.css',
                '/web/css/fonts/fonticons-1556595360772.woff',
                '/web/css/fonts/fonticons-1556595360772.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1556595360772.html');
        }

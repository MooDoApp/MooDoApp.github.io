var CacheName = 'moodo-cache-1529581210989',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1529581210989.html',
                '/web/js/vendor-1529581210989.js',
                '/web/js/delayedUI-1529581210989.js',
                '/web/js/dimport-1529581210989.js',
                '/web/js/main-min-1529581210989.js',
                '/web/js/preload-min-1529581210989.js',
                '/web/css/app-min-1529581210989.css',
                '/web/css/fonts/fonticons-1529581210989.woff',
                '/web/css/fonts/fonticons-1529581210989.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1529581210989.html');
        }

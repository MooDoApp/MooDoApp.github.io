var CacheName = 'moodo-cache-1551464637392',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1551464637392.html',
                '/web/js/vendor-1551464637392.js',
                '/web/js/delayedUI-1551464637392.js',
                '/web/js/dimport-1551464637392.js',
                '/web/js/app-1551464637392.js',
                '/web/js/preload-1551464637392.js',
                '/web/js/preload.worker-1551464637392.js',
                '/web/css/app-min-1551464637392.css',
                '/web/css/fonts/fonticons-1551464637392.woff',
                '/web/css/fonts/fonticons-1551464637392.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1551464637392.html');
        }

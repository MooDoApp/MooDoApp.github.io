var CacheName = 'moodo-cache-1565309071807',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1565309071807.html',
                '/web/js/vendor-1565309071807.js',
                '/web/js/delayedUI-1565309071807.js',
                '/web/js/dimport-1565309071807.js',
                '/web/js/app-1565309071807.js',
                '/web/js/preload-1565309071807.js',
                '/web/js/preload.worker-1565309071807.js',
                '/web/css/app-min-1565309071807.css',
                '/web/css/fonts/fonticons-1565309071807.woff',
                '/web/css/fonts/fonticons-1565309071807.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1565309071807.html');
        }

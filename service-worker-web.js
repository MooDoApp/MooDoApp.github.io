var CacheName = 'moodo-cache-1594300000616',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1594300000616.html',
                '/web/js/vendor-1594300000616.js',
                '/web/js/delayedUI-1594300000616.js',
                '/web/js/dimport-1594300000616.js',
                '/web/js/app-1594300000616.js',
                '/web/js/preload-1594300000616.js',
                '/web/js/preload.worker-1594300000616.js',
                '/web/css/app-min-1594300000616.css',
                '/web/css/fonticons-1594300000616.css',
                '/web/css/fonts/fonticons-1594300000616.woff',
                '/web/css/fonts/fonticons-1594300000616.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1594300000616.html');
        }

var CacheName = 'moodo-cache-1574676094192',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1574676094192.html',
                '/web/js/vendor-1574676094192.js',
                '/web/js/delayedUI-1574676094192.js',
                '/web/js/dimport-1574676094192.js',
                '/web/js/app-1574676094192.js',
                '/web/js/preload-1574676094192.js',
                '/web/js/preload.worker-1574676094192.js',
                '/web/css/app-min-1574676094192.css',
                '/web/css/fonts/fonticons-1574676094192.woff',
                '/web/css/fonts/fonticons-1574676094192.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1574676094192.html');
        }

var CacheName = 'moodo-cache-1572240080379',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1572240080379.html',
                '/web/js/vendor-1572240080379.js',
                '/web/js/delayedUI-1572240080379.js',
                '/web/js/dimport-1572240080379.js',
                '/web/js/app-1572240080379.js',
                '/web/js/preload-1572240080379.js',
                '/web/js/preload.worker-1572240080379.js',
                '/web/css/app-min-1572240080379.css',
                '/web/css/fonts/fonticons-1572240080379.woff',
                '/web/css/fonts/fonticons-1572240080379.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1572240080379.html');
        }

var CacheName = 'moodo-cache-1616403072068';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1616403072068.html',
                '/web/js/vendor-1616403072068.js',
                '/web/js/delayedUI-1616403072068.js',
                '/web/js/codeBlock-1616403072068.js',
                '/web/js/dimport-1616403072068.js',
                '/web/js/textEncoding-1616403072068.js',
                '/web/js/braintree-1616403072068.js',
                '/web/js/app-1616403072068.js',
                '/web/js/preload-1616403072068.js',
                '/web/js/preload.worker-1616403072068.js',
                '/web/css/app-min-1616403072068.css',
                '/web/css/fonticons-1616403072068.css',
                '/web/css/fonts/fonticons-1616403072068.woff',
                '/web/css/fonts/fonticons-1616403072068.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1616403072068.html');
        }

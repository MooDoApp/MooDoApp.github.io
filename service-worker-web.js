var CacheName = 'moodo-cache-1546901661551',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1546901661551.html',
                '/web/js/vendor-1546901661551.js',
                '/web/js/delayedUI-1546901661551.js',
                '/web/js/dimport-1546901661551.js',
                '/web/js/app-1546901661551.js',
                '/web/js/preload-1546901661551.js',
                '/web/js/preload.worker-1546901661551.js',
                '/web/css/app-min-1546901661551.css',
                '/web/css/fonts/fonticons-1546901661551.woff',
                '/web/css/fonts/fonticons-1546901661551.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1546901661551.html');
        }

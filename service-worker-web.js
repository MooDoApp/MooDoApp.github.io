var CacheName = 'moodo-cache-1558666774711',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1558666774711.html',
                '/web/js/vendor-1558666774711.js',
                '/web/js/delayedUI-1558666774711.js',
                '/web/js/dimport-1558666774711.js',
                '/web/js/app-1558666774711.js',
                '/web/js/preload-1558666774711.js',
                '/web/js/preload.worker-1558666774711.js',
                '/web/css/app-min-1558666774711.css',
                '/web/css/fonts/fonticons-1558666774711.woff',
                '/web/css/fonts/fonticons-1558666774711.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1558666774711.html');
        }

var CacheName = 'moodo-cache-1549376156100',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1549376156100.html',
                '/web/js/vendor-1549376156100.js',
                '/web/js/delayedUI-1549376156100.js',
                '/web/js/dimport-1549376156100.js',
                '/web/js/app-1549376156100.js',
                '/web/js/preload-1549376156100.js',
                '/web/js/preload.worker-1549376156100.js',
                '/web/css/app-min-1549376156100.css',
                '/web/css/fonts/fonticons-1549376156100.woff',
                '/web/css/fonts/fonticons-1549376156100.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1549376156100.html');
        }

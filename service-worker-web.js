var CacheName = 'moodo-cache-1544456589380',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1544456589380.html',
                '/web/js/vendor-1544456589380.js',
                '/web/js/delayedUI-1544456589380.js',
                '/web/js/dimport-1544456589380.js',
                '/web/js/app-1544456589380.js',
                '/web/js/preload-1544456589380.js',
                '/web/js/preload.worker-1544456589380.js',
                '/web/css/app-min-1544456589380.css',
                '/web/css/fonts/fonticons-1544456589380.woff',
                '/web/css/fonts/fonticons-1544456589380.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1544456589380.html');
        }

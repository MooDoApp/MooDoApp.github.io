        ...
        if (!this.isMobile() && !this.isLegacyBrowser()) {
            ...
            var onscroll = function (e) {
                ...
                if (this.getPageScrollOffset() - startScroll > 500 && !reportedScroll) {
                    ...
                    new Promise(function(resolve) { resolve(); }).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(36)]; ((function (util) {
...
var _HelpBasics = __webpack_require__(37);

var _HelpBasics2 = _interopRequireDefault(_HelpBasics);

var _HelpEmail = __webpack_require__(38);
...
exports.default = (0, _reactHotLoader.hot)(module)(function () {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'a',
                { style: { marginTop: 16 }, className: 'slackInvite', target: '_blank', href: 'https://join.slack.com/t/moodo/shared_invite/enQtMzY2MjMyNzg5OTU0LTg2ZWU1ODQxY2EyY2Y4ZWNiOWZkN2Q1MzllYjhlMGUzNzRhNmI2MTkzZjZkODliNmY1YmY0NmYxMmE4MjRiZTQ' },
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            if (true) {
                ...
                !function (r) {
                    function e(t) {
                        if (o[t]) return o[t].exports;var n = o[t] = { exports: {}, id: t, loaded: !1 };return r[t].call(n.exports, n, n.exports, e), n.loaded = !0, n.exports;
                    }var o = {};return e.m = r, e.c = o, e.p = "", e(0);
                }([function (r, e, o) {
                    "use strict";
                    var t = o(1).Rollbar,
                        n = o(2);_rollbarConfig.rollbarJsUrl = _rollbarConfig.rollbarJsUrl || "https://d37gvrvc0wt4s1.cloudfront.net/js/v1.9/rollbar.min.js";var a = t.init(window, _rollbarConfig),
                    ...
                    function o(r) {
                        ...
                        var e = function e() {
                            var e = Array.prototype.slice.call(arguments, 0);t(r, r._rollbarOldOnError, e);
                        };return e.belongsToShim = !0, e;
                    }function a(r) {
                        this.shimId = ++c, this.notifier = null, this.parentShim = r, this._rollbarOldOnError = null;
                    }function i(r) {
                        var e = a;return o(function () {
                            if (this.notifier) return this.notifier[r].apply(this.notifier, arguments);var o = this,
                                t = "scope" === r;t && (o = new e(this));var n = Array.prototype.slice.call(arguments, 0),
                                a = { shim: o, method: r, args: n, ts: new Date() };return window._rollbarShimQueue.push(a), t ? o : void 0;
                        });
                    }function l(r, e) {
                        if (e.hasOwnProperty && e.hasOwnProperty("addEventListener")) {
                            var o = e.addEventListener;e.addEventListener = function (e, t, n) {
                                o.call(this, e, r.wrap(t), n);
                            };var t = e.removeEventListener;e.removeEventListener = function (r, e, o) {
                                t.call(this, r, e && e._wrapped ? e._wrapped : e, o);
                            };
                        }
                    }var c = 0;a.init = function (r, e) {
                        var t = e.globalAlias || "Rollbar";if ("object" == _typeof(r[t])) return r[t];r._rollbarShimQueue = [], r._rollbarWrappedError = null, e = e || {};var i = new a();return o(function () {
                            if (i.configure(e), e.captureUncaught) {
                                i._rollbarOldOnError = r.onerror, r.onerror = n(i);var o,
                                    a,
                                    c = "EventTarget,Window,Node,ApplicationCache,AudioTrackList,ChannelMergerNode,CryptoOperation,EventSource,FileReader,HTMLUnknownElement,IDBDatabase,IDBRequest,IDBTransaction,KeyOperation,MediaController,MessagePort,ModalWindow,Notification,SVGElementInstance,Screen,TextTrack,TextTrackCue,TextTrackList,WebSocket,WebSocketWorker,Worker,XMLHttpRequest,XMLHttpRequestEventTarget,XMLHttpRequestUpload".split(",");for (o = 0; o < c.length; ++o) {
                                    a = c[o], r[a] && r[a].prototype && l(i, r[a].prototype);
                                }
                            }return e.captureUnhandledRejections && (i._unhandledRejectionHandler = function (r) {
                                var e = r.reason,
                                    o = r.promise,
                                    t = r.detail;!e && t && (e = t.reason, o = t.promise), i.unhandledRejection(e, o);
                            }, r.addEventListener("unhandledrejection", i._unhandledRejectionHandler)), r[t] = i, i;
                        })();
                    }, a.prototype.loadFull = function (r, e, t, n, a) {
                        var i = function i() {
                            var e;if (void 0 === r._rollbarPayloadQueue) {
                                var o, t, n, i;for (e = new Error("rollbar.js did not load"); o = r._rollbarShimQueue.shift();) {
                            ...
                            p = d.parentNode;c.crossOrigin = "", c.src = n.rollbarJsUrl, c.async = !t, c.onload = c.onreadystatechange = o(function () {
                            if (!(l || this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState)) {
                                c.onload = c.onreadystatechange = null;try {
                                    p.removeChild(c);
                                } catch (r) {}l = !0, i();
                            }
                        }), p.insertBefore(c, d);
                        ...
                        try {
                            var o;if (o = "function" == typeof e ? e : function () {
                                return e || {};
                                ...
                                }, r._wrapped._isWrap = !0;for (var t in r) {
                        ...
                        return function (o) {
                            if (!o && !window._rollbarInitialized) {
                                var t = window.RollbarNotifier,
                                    ...
                                    i = window.Rollbar.init(n, r);i._processShimQueue(window._rollbarShimQueue || []), window[a] = i, window._rollbarInitialized = !0, t.processPayloads();
                            }
                        };
                    };
                }]);
...
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 14)), (0, _importCss3.default)('src/containers/Us', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 15)), (0, _importCss3.default)('src/containers/Contact', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 16)), (0, _importCss3.default)('src/containers/Press', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 17)), (0, _importCss3.default)('src/containers/Privacy', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_7 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 18)), (0, _importCss3.default)('src/containers/Unsubscribe', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_8 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 19)), (0, _importCss3.default)('src/containers/Purchase', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_9 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 20)), (0, _importCss3.default)('src/containers/Invoice', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_10 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 21)), (0, _importCss3.default)('src/containers/Beta', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_12 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 23)), (0, _importCss3.default)('src/containers/404', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });

var CacheName = 'moodo-cache-1548847281496',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/newmobile/',
                '/newmobile/index-1548847281496.html',
                '/newmobile/js/vendor-1548847281496.js',
                '/newmobile/js/delayedUI-1548847281496.js',
                '/newmobile/js/app-1548847281496.js',
                '/newmobile/js/preload-1548847281496.js',
                '/newmobile/js/preload.worker-1548847281496.js',
                '/newmobile/css/app-min-1548847281496.css',
                '/newmobile/css/fonts/fonticons-1548847281496.woff',
                '/newmobile/css/fonts/fonticons-1548847281496.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1548847281496.html');
        }

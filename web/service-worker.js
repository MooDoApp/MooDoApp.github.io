var CacheName = 'moodo-cache-1632034796280';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1632034796280.html',
                '/web/js/vendor-1632034796280.js',
                '/web/js/delayedUI-1632034796280.js',
                '/web/js/codeBlock-1632034796280.js',
                '/web/js/dimport-1632034796280.js',
                '/web/js/textEncoding-1632034796280.js',
                '/web/js/braintree-1632034796280.js',
                '/web/js/app-1632034796280.js',
                '/web/js/preload-1632034796280.js',
                '/web/js/preload.worker-1632034796280.js',
                '/web/css/app-min-1632034796280.css',
                '/web/css/fonticons-1632034796280.css',
                '/web/css/fonts/fonticons-1632034796280.woff',
                '/web/css/fonts/fonticons-1632034796280.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1632034796280.html');
        }
